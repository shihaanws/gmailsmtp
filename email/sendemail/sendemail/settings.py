...
SECRET_KEY = '%7$x3=303zf2!o=#ow%3$vpu0h65(quy-3o69m!y4c6l!c40ik'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR ,'templates')], #set the base directory's template here
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_USE_TLS=True
EMAIL_PORT=587
EMAIL_HOST_USER='frommailaddress@gmail.com'  #type your from mail address here
